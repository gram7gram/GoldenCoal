...
class Version20171205173608 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("INSERT INTO event_bundle_region (created_at, name, type) VALUES (now(), 'Дніпровська область', null)");
        ...
        $this->addSql("INSERT INTO event_bundle_region (created_at, name, type) VALUES (now(), 'Кропивницька область', null)");
